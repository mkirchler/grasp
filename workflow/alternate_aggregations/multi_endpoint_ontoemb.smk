...
SETTING_NAME = "attention_fulltable_endpointsel_from_omop_multi_ontoemb"
...
SPEC_PARAMS = {
    ...
    "embed_dim": [256],
    "sources": [
        # "condition_occurrence?procedure_occurrence?extra",
        "condition_occurrence?procedure_occurrence?drug_exposure?extra",
    ],
...
wildcard_constraints:
    ...
    # input_dim="|".join([str(x) for x in SPEC_PARAMS["input_dim"]]),
...
rule export_with_downstream:
    input:
        ...
        #     # "results/{setting_name}/demo_{endpoint}.pkl",
        #     endpoint=ENDPOINTS,
        #     setting_name=SETTING_NAME,
...
rule aggregate_demo_endpoint:
    ...
    output:
        # f"results/{SETTING_NAME}/demo_{{endpoint}}.pkl",
